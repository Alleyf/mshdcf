...
//            throw new ServiceException(e.getMessage());
    ...
    private static String xiaKeRequest(String text) {
        ...
        geminiGPTBo.setContents("你是专业的数据智能处理和挖掘助手", text);
