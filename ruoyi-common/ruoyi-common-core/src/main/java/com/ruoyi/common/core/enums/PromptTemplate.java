...
public enum PromptTemplate {
    ...
    LAWEXTRA("lawMining", "参考示例：\n" +
        ...
        "、适用范围、法条依据、主要内容和摘要总结（不少于100字），保证参考示例中的所有字段必须有，对于确实无法提取得到的json字段则令其值为null，最终返回不带markdown代码格式的json字符串纯文本\n" +
        "法条正文：" + "\n"),

    /**
     * 案例正文修正模板
     */
    CASEREVISE("caseRevise", "修正下述司法案例正文的格式并纠正可能存在的语法错误后返回:\n"),
    /**
     * 法条正文修正模板
     */
