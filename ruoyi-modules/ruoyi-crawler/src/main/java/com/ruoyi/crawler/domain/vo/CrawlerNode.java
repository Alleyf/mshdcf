...
public class CrawlerNode {
     ...
     */
    public static List<CrawlerNode> map(JSONArray jsonArray) {
        return jsonArray.toJavaList(JSONObject.class).stream().map(CrawlerNode::getCrawlerNode).collect(Collectors.toList());
    }
     ...
     * @return CrawlerNode
     */
    public static CrawlerNode map(JSONObject jsonObject) {
        return getCrawlerNode(jsonObject);
    }

    private static CrawlerNode getCrawlerNode(JSONObject jsonObject) {
