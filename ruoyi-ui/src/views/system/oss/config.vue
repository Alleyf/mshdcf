<template>
  <div class="app-container">
    ...
    <el-table v-loading="loading" :data="ossConfigList" @selection-change="handleSelectionChange">
      ...
      <el-table-column v-if="false" align="center" label="主建" prop="ossConfigId"/>
      <el-table-column align="center" label="配置key" prop="configKey" />
      <el-table-column align="center" label="访问站点" prop="endpoint" width="200" />
      <el-table-column align="center" label="自定义域名" prop="domain" width="200" />
      <el-table-column align="center" label="桶名称" prop="bucketName" />
      <el-table-column align="center" label="前缀" prop="prefix" />
      <el-table-column align="center" label="域" prop="region" />
      <el-table-column align="center" label="桶权限类型" prop="accessPolicy">
